const passwd = require('../../../src/passwd');
...
describe('passwd', () => {
  ...
  it('must have a minimum of 3 characters', () => {
    process.env.ENV_PASSWORD_RULES = 'minlength:3';
  ...
  it('must have a maximum of 10 characters', () => {
    process.env.ENV_PASSWORD_RULES = 'maxlength:10';
  ...
  it('must have a minimum of 2 numeric characters', () => {
    process.env.ENV_PASSWORD_RULES = 'digits:2';
  ...
  it('must have a minimum of 2 uppercase characters', () => {
    process.env.ENV_PASSWORD_RULES = 'caps:2';
  ...
  it('must have a minimum of 2 special characters', () => {
    process.env.ENV_PASSWORD_RULES = 'special:2';
  ...
  it('must not have invalid characters', () => {
    process.env.ENV_PASSWORD_RULES = 'minlength:1';
    expect(passwd.checkRules('@#^[/')).toEqual(['Password must contain only valid characters: 0-9, A-Z, a-z, !@#$%']);
  });

  it('must accept all mixed rules', () => {
    process.env.ENV_PASSWORD_RULES = 'minlength:4,maxlength:10,digits:1,special:1,caps:1';
    expect(passwd.checkRules('Ab@defgh1j')).toEqual([]);
  });

  it('must complain about mixed rules', () => {
    process.env.ENV_PASSWORD_RULES = 'minlength:2,maxlength:4,digits:1,special:1,caps:1';
